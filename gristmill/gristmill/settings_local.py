...
# 1.check - turn DEBUGging off
DEBUG = True
# 2.check - turn TEMPLATE_DEBUGging off (set to FALSE)
TEMPLATE_DEBUG = DEBUG

# 3. check - add ADMIN emails
...
DATABASES = {
    'default': {
        ...
        'NAME': '/Users/tali/Devel/gristmill_biz/gristmill/gmdb', # Or path to database file if using sqlite3.
...
MEDIA_ROOT = '/Users/tali/Devel/gristmill_biz/gristmill/media/'
...
STATIC_ROOT = '/Users/tali/Devel/gristmill_biz/gristmill/static/'
...
STATICFILES_DIRS = (
	...
	"/Users/tali/Devel/gristmill_biz/gristmill/gristmill/static/",
)
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
   '/Users/tali/Devel/gristmill_biz/gristmill/templates', # Change this to your own directory.
   '/Users/tali/Devel/gristmill_biz/gristmill/my_tags/templatetags/templates', # Change this to your own directory.
)
#TEMPLATE_DIRS = (	 
